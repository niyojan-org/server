...
export const getNotificationStats = asyncHandler(async (req: AuthenticatedRequest, res) => {
  const userId = req.user!._id.toString();
...
export const archiveNotification = asyncHandler(async (req: AuthenticatedRequest, res) => {
  const userId = req.user!._id.toString();
...
export const deleteReadNotifications = asyncHandler(async (req: AuthenticatedRequest, res) => {
  const userId = req.user!._id.toString();
...
export const deleteAllNotifications = asyncHandler(async (req: AuthenticatedRequest, res) => {
  const userId = req.user!._id.toString();
...
export const createNotification = asyncHandler(async (req: AuthenticatedRequest, res) => {
  // Validate request body
