...
describe('Ticket Module - Ticket Service', () => {
  ...
  describe('Ticket Availability', () => {
    ...
    it('should track sold quantity', () => {
      let ticket = { quantity: 100, sold: 0 };
      ticket.sold += 5;
  ...
  describe('Ticket Validation Rules', () => {
    ...
    it('should check quantity constraints', () => {
      ...
      const isValid = requestedQuantity >= ticket.minQuantity && 
                     requestedQuantity <= ticket.maxQuantity;
      expect(isValid).toBe(true);
    });
    ...
    it('should check category restrictions', () => {
      ...
      const canBook = !ticket.requiredMembership || 
                     user.membership === ticket.requiredMembership;
      expect(canBook).toBe(true);
    });
  });
